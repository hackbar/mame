...
static INPUT_PORTS_START( tempest )
	...
	PORT_BIT(0x80, IP_ACTIVE_LOW, IPT_UNKNOWN )
        ...
        PORT_START("DSW1")
        PORT_DIPNAME( 0x03, 0x00, DEF_STR( Coinage ) )  PORT_DIPLOCATION("SW:7,8")
        PORT_DIPSETTING (   0x03, DEF_STR( 2C_1C ) )
        PORT_DIPSETTING (   0x01, DEF_STR( 1C_1C ) )
        PORT_DIPSETTING (   0x02, DEF_STR( 1C_2C ) )
        PORT_DIPSETTING (   0x00, DEF_STR( Free_Play ) )
        PORT_DIPNAME( 0x0c, 0x00, "Right Mech" )        PORT_DIPLOCATION("SW:5,6")
        PORT_DIPSETTING (   0x00, "X 1" )
        PORT_DIPSETTING (   0x08, "X 4" )
        PORT_DIPSETTING (   0x04, "X 5" )
        PORT_DIPSETTING (   0x0c, "X 6" )
        PORT_DIPNAME( 0x10, 0x00, "Center Mech" )       PORT_DIPLOCATION("SW:4") // Left/Center for 3-door mech
        PORT_DIPSETTING (   0x00, "X 1" )
        PORT_DIPSETTING (   0x10, "X 2" )
        PORT_DIPNAME( 0x20, 0x20, DEF_STR( Lives ) )    PORT_DIPLOCATION("SW:3")
        PORT_DIPSETTING (   0x20, "3" )
        PORT_DIPSETTING (   0x00, "4" )
        PORT_DIPNAME( 0xc0, 0x00, DEF_STR( Language ) ) PORT_DIPLOCATION("SW:1,2")
        PORT_DIPSETTING (   0x00, DEF_STR( English ) )
        PORT_DIPSETTING (   0x80, DEF_STR( German ) )
...
GAME( 1980, tempast,   0,       tempest, tempest, tempest_state, empty_init, ROT270, "Atari", "Tempest (Asteroids)", MACHINE_SUPPORTS_SAVE )
