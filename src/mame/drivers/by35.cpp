...
ROM_START(flashgvf)
	...
	ROM_REGION(0x10000, "sounds_plus:cpu", 0)
	ROM_LOAD("834-02_4.532", 0xf000, 0x1000, CRC(f1eb0a12) SHA1(a58567665547aacf9a1b2c39295d963527ef8696))
	ROM_LOAD("834-03_1.532", 0x8000, 0x1000, CRC(2152efff) SHA1(07d2af3e1f9077548e3932fd1d104275de889eae))
	ROM_LOAD("834-04_2.532", 0x9000, 0x1000, CRC(01d0bb0f) SHA1(77a35f357d712e9d24e56b45d04dc28b372d8634))
	ROM_LOAD("834-05_3.532", 0xa000, 0x1000, CRC(8beb4a87) SHA1(bd415303e73950a19b02226d35ee5c12fe58e300))
	ROM_LOAD("834-06_4.532", 0xb000, 0x1000, BAD_DUMP CRC(00000000) SHA1(0000000000000000000000000000000000000000))
	ROM_LOAD("834-07_5.532", 0xc000, 0x1000, CRC(a2e4cfd3) SHA1(ba1501d9d1d7af406affd53e80eb08afa6219036))
	ROM_LOAD("834-08_6.532", 0xd000, 0x1000, CRC(d18c6803) SHA1(a24a8a63280ed365618592de8690985ed1797cfd))
	ROM_LOAD("834-09_7.532", 0xe000, 0x1000, CRC(19ceabd1) SHA1(37e7780f2ba3e06462e775547278dcba1b6d2ac8))
ROM_END
...
GAME( 1981, flashgvf,  flashgdn, sounds_plus,      by35_os5x, by35_state, init_by35_7, ROT0, "Bally", "Flash Gordon (Vocalizer sound, French)", MACHINE_MECHANICAL | MACHINE_NOT_WORKING)
